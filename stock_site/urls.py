...
urlpatterns = [
    ...
    path('exchange/<str:pk>', views.Exchange_.as_view()),
    path('stock/<str:pk>', views.Stock_.as_view()),
    path('put/<str:ed>/<str:sp>/<str:t>', views.Put_.as_view()),
    path('call/<str:ed>/<str:sp>/<str:t>', views.Call_.as_view()),
    path('valuehistory/<str:d>/<str:ticker>', views.ValueHistory_.as_view()),
